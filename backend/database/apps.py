...
if DATABASE_CHOICE == "postgres":
    print("Using PostgreSQL database implementation for apps.")
    from .postgres.apps import *
else:
    print("Using Firestore database implementation for apps.")
    from .firestore.apps import *

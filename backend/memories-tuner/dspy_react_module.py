...
class GenerateMemories(Signature):
    ...
    interesting_memories: list = dspy.OutputField(description="List of up to 2 interesting personal memories about the user")
    system_memories: list = dspy.OutputField(description="List of up to 2 system-relevant memories about interaction patterns")
        ...
        if DUMMY_MODE:
            if "japan" in context.lower():
                ...
                return GenerateMemories(
                    ...
                    user_name=user_name,
                    interesting_memories=[
                        f"{user_name} mentioned topic X", 
                        f"{user_name} expressed preference for Y"
                    ],
                    system_memories=[
